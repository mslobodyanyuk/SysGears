 ...
 * separate class (src\Controller\DegreeTranslateController) and method (indexAction)
 * and creates a $controller = new src\Controller\DegreeTranslateController(), returns the data to render().
 * it is necessary to perform a controller method and obtain the data and return from it.
 * $param = [ '/', 'src\Controller\DegreeTranslateController.indexAction' ];
 */
